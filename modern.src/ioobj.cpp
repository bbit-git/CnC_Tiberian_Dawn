 ...
 * On 64-bit, (TARGET)ptr loses precision. We use a macro to go through intptr_t.
 * TODO: Rewrite save/load for proper 64-bit support.
 */
#define ENCODE_PTR(type, ptr) ((type)(intptr_t)(ptr))
...
void TeamTypeClass::Decode_Pointers(void)
{
	...
	*/
	for (int i = 0; i < ClassCount; i++) {
		Class[i] =  Target_To_TechnoType(ENCODE_PTR(TARGET, Class[i]));
...
void TeamClass::Decode_Pointers(void)
{
	...
	*/
	((TeamTypeClass *&)Class) = As_TeamType(ENCODE_PTR(TARGET, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
	((HouseClass *&)House) = HouseClass::As_Pointer(ENCODE_PTR(HousesType, House));
	...
	*/
	if (Member) {
		switch (Target_Kind(ENCODE_PTR(TARGET, Member))) {
			case KIND_INFANTRY:
				Member = As_Infantry(ENCODE_PTR(TARGET, Member));
				break;

			case KIND_UNIT:
				Member = As_Unit(ENCODE_PTR(TARGET, Member));
				break;

			case KIND_AIRCRAFT:
				Member = As_Aircraft(ENCODE_PTR(TARGET, Member));
				break;
...
{
	if (Team) {
		Team = As_TeamType(ENCODE_PTR(TARGET, Team));
...
void AircraftClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((AircraftTypeClass const *&)Class) = &AircraftTypeClass::As_Reference(ENCODE_PTR(AircraftType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void AnimClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((AnimTypeClass const *&)Class) = &AnimTypeClass::As_Reference(ENCODE_PTR(AnimType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
	...
	*/
	if (Object) {
		Object = As_Object(ENCODE_PTR(TARGET, Object));
...
void BuildingClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((BuildingTypeClass const *&)Class) = &BuildingTypeClass::As_Reference(ENCODE_PTR(StructType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void BulletClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((BulletTypeClass const *&)Class) = &BulletTypeClass::As_Reference(ENCODE_PTR(BulletType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
	...
	*/
	if (Payback) {
		Payback = As_Techno(ENCODE_PTR(TARGET, Payback));
...
void InfantryClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((InfantryTypeClass const *&)Class) = &InfantryTypeClass::As_Reference(ENCODE_PTR(InfantryType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void OverlayClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((OverlayTypeClass const *&)Class) = &OverlayTypeClass::As_Reference(ENCODE_PTR(OverlayType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void SmudgeClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((SmudgeTypeClass const *&)Class) = &SmudgeTypeClass::As_Reference(ENCODE_PTR(SmudgeType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void TemplateClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((TemplateTypeClass const *&)Class) = &TemplateTypeClass::As_Reference(ENCODE_PTR(TemplateType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
void TerrainClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((TerrainTypeClass const *&)Class) = &TerrainTypeClass::As_Reference(ENCODE_PTR(TerrainType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
{
	if (Object) {
		Object = As_Techno(ENCODE_PTR(TARGET, Object));
		Check_Ptr((void *)Object,__FILE__,__LINE__);
	}
...
void LayerClass::Decode_Pointers(void)
{
	...
	for (int i = 0; i < Count(); i++) {
		target = ENCODE_PTR(TARGET, (*this)[i]);
...
void HouseClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((HouseTypeClass const *&)Class) = &HouseTypeClass::As_Reference(ENCODE_PTR(HousesType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
}
...
void DriveClass::Decode_Pointers(void)
{
	...
	----------------------------- Decode 'Class' -----------------------------
	*/
	((UnitTypeClass const *&)Class) = &UnitTypeClass::As_Reference(ENCODE_PTR(UnitType, Class));
	Check_Ptr((void *)Class,__FILE__,__LINE__);
...
{
	if (Team) {
		Team = As_Team(ENCODE_PTR(TARGET, Team));
		Check_Ptr((void *)Team,__FILE__,__LINE__);
	}

	if (Member) {
		Member = (FootClass *)As_Techno(ENCODE_PTR(TARGET, Member));
		Check_Ptr((void *)Member,__FILE__,__LINE__);
	}
...
void RadioClass::Decode_Pointers(void)
{
	...
	*/
	if (Radio) {
		Radio = As_Techno(ENCODE_PTR(TARGET, Radio));
...
void CargoClass::Decode_Pointers(void)
{
	...
	*/
	if (CargoHold) {
		CargoHold = (FootClass *)As_Techno(ENCODE_PTR(TARGET, CargoHold));
