...
class RawFileClass : public FileClass
{
	public:
		...
		*/
		...
		void Set_Buffer_Size(int) {} /* no-op on modern systems */
		int Get_File_Handle(void) { return Handle; }
